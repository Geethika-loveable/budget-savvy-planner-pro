...
import { Plus, Download, Calendar, DollarSign, Trash2, LogIn } from 'lucide-react';
...
const Events = () => {
  ...
  const addEvent = (eventData: Omit<Event, 'id' | 'createdAt'>) => {
    ...
    toast({
      ...
      description: `Your ${eventData.type.toLowerCase()} budget "${eventData.title}" has been created successfully.`,
    });
  };
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Create, manage, and track your event and trip budgets with ease. 
            Get detailed insights and beautiful PDF reports.
          </p>
        </div>
        ...
        <Card className="mb-8 bg-slate-800/50 border-purple-500/20">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-gray-300">
              Start planning your next adventure or event with a detailed budget
            </CardDescription>
          </CardHeader>
